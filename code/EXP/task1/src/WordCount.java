...
public class WordCount {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // Input path format: /user/root/task1/input_wordcount_500MB or input_terasort_1GB
        ...
        // Task1: Parameter sensitivity analysis with different data sizes
        String jobName = String.format("Task1_%s_%s_slowstart%s_reducers%d", 
