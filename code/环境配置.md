...
| 节点名称 | 内网IP | 公网IP | 角色 |
|---------|--------|--------|------|
| master  | 172.31.12.133 | 47.116.119.3 | NameNode, ResourceManager, DataNode, NodeManager |
...
- **HDFS NameNode**：http://47.116.119.3:9870
- **YARN ResourceManager**：http://47.116.119.3:8088
...
- [ ] 本地电脑 hosts 文件已配置（47.116.119.3 master）
